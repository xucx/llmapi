...
func (e *Event) UnmarshalJSON(data []byte) error {
	e.EventPayload = map[string]any{}
	if err := json.Unmarshal(data, &e.EventPayload); err != nil {
		return err
	}

	e.EventBase = EventBase{}
	if t, ok := e.EventPayload["type"].(string); ok {
		e.EventBase.Type = EventType(t)
	}
	if id, ok := e.EventPayload["event_id"].(string); ok {
		e.EventBase.EventId = id
	}

	delete(e.EventPayload, "type")
	delete(e.EventPayload, "event_id")
...
func NewClientEventSessionUpdate() *ClientEventSessionUpdate {
	return &ClientEventSessionUpdate{
		EventBase: EventBase{Type: ClientEventTypeSessionUpdate},
	}
}
...
func NewClientEventConversationItemCreate() *ClientEventConversationItemCreate {
	return &ClientEventConversationItemCreate{
		EventBase: EventBase{
...
func NewClientEventInputAudioBufferAppend() *ClientEventInputAudioBufferAppend {
	return &ClientEventInputAudioBufferAppend{
		EventBase: EventBase{
...
func NewClientEventResponseCreate() *ClientEventResponseCreate {
	return &ClientEventResponseCreate{
		EventBase: EventBase{
...
func UnmarshalServerEvent(data []byte) (EventType, any, error) {
	eventBase := EventBase{}
	if err := json.Unmarshal(data, &eventBase); err != nil {
		return "", nil, err
	}
	...
	case ServerEventTypeResponseOutputAudioDelta:
		event = &ServerEventResponseOutputAudioDelta{}
	...
	return eventBase.Type, event, nil
}
...
// 	NoiseReduction *InputAudioNoiseReduction `json:"noise_reduction"`
// 	Transcription  *InputAudioTranscription  `json:"transcription"`
// 	TurnDetection  *ServerTurnDetection      `json:"turn_detection"`
// }
...
// 	Type AudioFormatType `json:"type"`
// 	// for audio/pcm
...
// 	MaxOutputTokens utils.IntOrInf `json:"max_response_output_tokens,omitempty"`
...
// 		return unmarshalServerEvent[ConversationItemAdded](data)
// 	case ServerEventTypeConversationItemDone:
// 		return unmarshalServerEvent[ConversationItemDone](data)
// 	case ServerEventTypeResponseOutputAudioDelta:
...
// 	Temperature *float32 `json:"temperature,omitempty"`
// 	// Maximum number of output tokens for a single assistant response, inclusive of tool calls. Provide an integer between 1 and 4096 to limit output tokens, or "inf" for the maximum available tokens for a given model. Defaults to "inf".
// 	MaxOutputTokens utils.IntOrInf `json:"max_output_tokens,omitempty"`
// }
